...
namespace mongo {
    ...
    LevelServerStatusSection::LevelServerStatusSection(LevelEngine* engine)
        : ServerStatusSection("leveldb"), _engine(engine) {}

    bool LevelServerStatusSection::includeByDefault() const { return true; }

    BSONObj LevelServerStatusSection::generateSection(OperationContext* txn,
        ...
        for (auto const& property : properties) {
            ...
            if (!_engine->getDB()->GetProperty("leveldb." + property.first, &statsString)) {
        ...
        bob.append("total-live-recovery-units", LevelRecoveryUnit::getTotalLiveRecoveryUnits());
        ...
        LevelEngine::appendGlobalStats(bob);
