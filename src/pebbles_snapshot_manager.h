...
class LevelSnapshotManager final : public SnapshotManager {
    MONGO_DISALLOW_COPYING(LevelSnapshotManager);
...
public:
    ...
    std::shared_ptr<LevelSnapshotManager::SnapshotHolder> getCommittedSnapshot() const;
