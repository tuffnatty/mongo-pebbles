...
namespace mongo {
    ...
    class LevelTransactionEngine {
    public:
        LevelTransactionEngine();
    ...
    class LevelTransaction {
    public:
        LevelTransaction(LevelTransactionEngine* transactionEngine)
    ...
    private:
        ...
        friend class LevelTransactionEngine;
